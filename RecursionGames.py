...
def main():
    ...
    9) Quit")
        ...
        # sumToTarget input validation
            ...
            # Get initial input, set valid to False
            stt = input("Enter a list of numbers and a positive integer (ex:\
[1,2,3],5): ")
            sttValid = False
            ...
            while not sttValid:
                ...
                if not sttValid:
                    print("\nPlease enter the inputs in the correct format, with a positive x.")
                    stt = input("\nEnter a list of numbers and a positive integer (ex:\
[1,2,3],5): ")
                        
            print(sumToTarget(sttList, x))
